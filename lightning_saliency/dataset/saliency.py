...
from lightning_saliency.utils import to_tensor_format
from lightning_saliency.io import read_rgb, read_binary
...
class SaliencyDataset(Dataset):
    ...
    def __init__(
        ...
        # it's a list of dict with {"image": path, "mask": path}
